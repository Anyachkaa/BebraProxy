package ru.justnanix.bebraproxy.network.data.util;

import ru.justnanix.bebraproxy.network.codec.PacketBuffer;
import ru.justnanix.bebraproxy.network.data.*;
import ru.justnanix.bebraproxy.network.data.chunk.Chunk;
import ru.justnanix.bebraproxy.network.data.chunk.NetworkChunkData;
import ru.justnanix.bebraproxy.network.data.chunk.ParsedChunkData;
