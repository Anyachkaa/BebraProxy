...
public class PacketBuffer extends ByteBuf {
    ...
    public void writeTextComponent(BaseComponent[] message) {
        this.writeString(ComponentSerializer.toString(message));
    }

    public BaseComponent[] readTextComponent() {
        return ComponentSerializer.parse(this.readString(32767));
    }
